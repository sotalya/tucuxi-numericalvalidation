...
$DES
DADT(1) = -KA * A(1)
DADT(2) =  KA * A(1) - VMAX*(A(2))/(KM+(A(2)/S2)) - K20*A(2) - K23*A(2) + K32*A(3)
...
$TABLE ID TIME EVID DV S2_SAMPLING PRED IPRED CL VMAX VC KM KA VP Q ETA1 ETA2 ETA3 ETA4 AUC CMAX TMAX NOPRINT NOAPPEND ONEHEADER FILE=run213.tab FORMAT=,
