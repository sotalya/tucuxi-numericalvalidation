...
$OMEGA STANDARD CORRELATION BLOCK(1)
0.45 ; KA
...
$TABLE ID TIME EVID DV S2_SAMPLING PRED IPRED CL VC KA ETA1 ETA2 AUC CMAX TMAX NOPRINT NOAPPEND ONEHEADER FILE=run514.tab FORMAT=,
