...
DEL=0
IPRED=F
W=SQRT(THETA(4)**2*IPRED**2 + THETA(5)**2) * ETA(4)
Y=F+W
IRES=DV-IPRED
IWRES=IRES/W
...
$TABLE ID TIME EVID DV S2_SAMPLING PRED IPRED CL VC KA ETA1 ETA2 ETA3 ETA4 AUC CMAX TMAX NOPRINT NOAPPEND ONEHEADER FILE=run405.tab FORMAT=,
