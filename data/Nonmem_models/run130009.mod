...
$TABLE ID TIME EVID DV S2_SAMPLING PRED IPRED CL VC KA VP Q V3 Q3 ETA1 ETA2 ETA3 ETA4 ETA5 AUC CMAX TMAX NOPRINT NOAPPEND ONEHEADER FILE=run103.tab FORMAT=,
